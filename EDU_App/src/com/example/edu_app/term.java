...
public class term extends Activity {
	...
	public final String METHOD_NAME =  "getmarks"; // our webservice method name
	public final String NAMESPACE = "http://tempuri.org/";
	public final String SOAP_ACTION = "http://tempuri.org/getmarks"; // NAMESPACE + method name
	public final String URL = "http://glauniversity.in/Result.asmx";
	String r="R",g="G",y="B";
	static final String[] totalheading = new String[] {

        "Code","Name","Ist","Mid","End"  
    };	
	String[] web = {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String name1 = getIntent().getExtras().getString("uname");
		String rollno = getIntent().getExtras().getString("name");
       ...
       //here finding length of array
        ...
        SimpleAdapter arrayAdapter2 =
                       new SimpleAdapter(this, mylistData2, R.layout.termhead, columnTags2 , columnIds2);
        ...
        try
		{
	       ...
	       //here finding length of array
	        ...
	        SimpleAdapter arrayAdapter =
	        new SimpleAdapter(this, mylistData, R.layout.term_data, columnTags , columnIds);
	        list.setAdapter(arrayAdapter); 
			...
			E.printStackTrace();
			Toast t1 =  Toast.makeText(getApplicationContext(), " Terms Marks is not updated ", Toast.LENGTH_LONG);
			t1.show();
			}
}
