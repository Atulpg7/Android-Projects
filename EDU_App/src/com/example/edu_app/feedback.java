 ...
 @Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Intent i=new Intent(this,MainActivity.class );
		 Toast t1 =   Toast.makeText(feedback.this, radioSexButton.getText(), Toast.LENGTH_SHORT);	
		// t1.show();	
		 
		 if( ed1.getText().toString().trim().equals(""))
		 {    
			 ed1.setError( "Comments is required!" );
		 ...
		 try
			...
			if(result.toString().equals("Valid"))
			{
				ed1.setText("");
				    ...
				    //Intent i=new Intent(feedback.this,another1.class );
		        	//startActivity(i); 
