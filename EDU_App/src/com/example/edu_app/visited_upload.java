...
public class visited_upload extends Activity  implements OnClickListener {
	public final String METHOD_NAME =  "uvcompany"; // our webservice method name
	public final String NAMESPACE = "http://tempuri.org/";
	public final String SOAP_ACTION = "http://tempuri.org/uvcompany"; // NAMESPACE + method name
...
@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.visited_upload);
		...
		public void onClick(View v) {
			...
			try{
				...
				request.addProperty("branch",et2.getText().toString());
				request.addProperty("nop",et3.getText().toString());
