...
public class upcoming_company extends Activity {
	public final String METHOD_NAME =  "ucompany"; // our webservice method name
	public final String NAMESPACE = "http://tempuri.org/";
	public final String SOAP_ACTION = "http://tempuri.org/ucompany"; // NAMESPACE + method name
	public final String URL = "http://glauniversity.in/Result.asmx";

String heading[];
String upcoming_company[];
...
@Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.upcoming_company); 
...
// for news
         try
         {
    		...
    		request1.addProperty("servicetype","SOFT");
 			...
 			upcoming_company = new String[result1.getPropertyCount()];
 			for(int j=0 ; j<=result1.getPropertyCount();j++)
 			{
 				upcoming_company[j]=result1.getProperty(j).toString();
 			}
         }
         catch (Exception E) {
         	E.printStackTrace();
        ...
        int k=0;
       //here finding length of array
        for(int i=0;i<(upcoming_company.length)/3; i++)
        {
        ...
        for(int j=0; j<3; j++)
         {
          ...
          map.put(columnTags[j],upcoming_company[k]);
