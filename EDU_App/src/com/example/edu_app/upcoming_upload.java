...
public class upcoming_upload extends Activity  implements OnClickListener {
	public final String METHOD_NAME =  "uucompany"; // our webservice method name
	public final String NAMESPACE = "http://tempuri.org/";
	public final String SOAP_ACTION = "http://tempuri.org/uucompany"; // NAMESPACE + method name
...
@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.upcoming_upload);
