...
{ String id4=getIntent().getExtras().getString("id3");
    ...
    case R.id.sem1:
         ...
         break;
     case R.id.sem2:
    	 Intent j=new Intent(this,resultButton1.class );
    	...
    	startActivity(j);
         break;
     case R.id.sem3:
    	 Intent k=new Intent(this,resultButton1.class );
    	...
    	startActivity(k);
         break;
     case R.id.sem4:
    	 Intent l=new Intent(this,resultButton1.class );
    	...
    	startActivity(l);
         break;
     case R.id.sem5:
    	 Intent m=new Intent(this,resultButton1.class );
    	...
    	startActivity(m);
         break;
     case R.id.sem6:
    	 Intent n=new Intent(this,resultButton1.class );
    	...
    	startActivity(n);
         break;
     case R.id.sem7:
    	 Intent o=new Intent(this,resultButton1.class );
     ...
     o.putExtra("uname", uname1);
    	startActivity(o);
         break;
     case R.id.sem8:
    	 Intent p=new Intent(this,resultButton1.class );
