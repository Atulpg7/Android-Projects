...
public class Custom_Adapter_AllUser extends ArrayAdapter {
    ...
    public Custom_Adapter_AllUser(Activity activity, ArrayList<String> name,
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        tvmobileoffice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (number.equals("NA"))
                {
                    Toast.makeText(activity, "Number not Avalable ?", Toast.LENGTH_SHORT).show();
                }
                else {
                    call(number);
                }
