...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // city=getIntent().getStringExtra("city");
        ...
        new Data_Process_Result().execute();



    }

    class Data_Process_Result extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try
            {
                ...
                request.addProperty("blood_group",""+bloodgroup);
                request.addProperty("distic",""+district);
        ...
        protected void onPostExecute(String s) {
            ...
            if (task.equals("true")) {
                ...
                task="false";
                Toast.makeText(ResultActivity.this, "Please check your Internet Connection ??", Toast.LENGTH_LONG).show();

            }
            else
            {
                task="false";
                Toast.makeText(ResultActivity.this, "Result Loaded", Toast.LENGTH_LONG).show();
                Custom_Adapter_Admin_ListView adapter_admin_listView=new Custom_Adapter_Admin_ListView(ResultActivity.this,
