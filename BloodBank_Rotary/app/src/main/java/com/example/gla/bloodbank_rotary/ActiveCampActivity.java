...
public class ActiveCampActivity extends AppCompatActivity {
    ...
    Custom_Active_Camp adapter;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_active_camp);


        getSupportActionBar().setTitle("Active Camps");
    ...
    class Data_Process_login extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setMessage("Please Wait While We Loading Active Camps...");
        ...
        protected void onPostExecute(String s) {
            ...
            if (task.equals("true")) {
                ...
                task="false";
                Toast.makeText(ActiveCampActivity.this, "No Camp Active ? Add new one !!", Toast.LENGTH_SHORT).show();
            }
            else if(task.equals("false")){

                task="false";
                Toast.makeText(ActiveCampActivity.this, "Please check your Internet Connection ??", Toast.LENGTH_SHORT).show();

            }
            else
            {
                task="false";
                Toast.makeText(ActiveCampActivity.this, "Camps Loaded Sucessfully", Toast.LENGTH_SHORT).show();
                adapter=new Custom_Active_Camp(ActiveCampActivity.this,campid,campname,startingdate,closingdate,address,contactname,contactmob);
